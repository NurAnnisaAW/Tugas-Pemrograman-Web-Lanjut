        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> List Data Anggota</h4>
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header">
               		<i class="bi bi-user-plus"></i>Data Anggota</h5>
                              ...
                              <td>
                                ...
                                <div class='dropdown'>
                                  ...
                                  <div class='dropdown-menu'>
                                    <a class='dropdown-item' href='editAnggota.php?kode=$data->id_anggota'
                                      ><i class='bx bx-edit-alt me-1'></i> Edit</a
                                    >
                                    <a class='dropdown-item' href='view_all_anggota.php?delete=$data->id_anggota'
