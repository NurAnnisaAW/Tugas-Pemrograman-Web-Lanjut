        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> List Data Simpanan</h4>
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header">
               		<i class="bi bi-user-plus"></i>Data Simpanan</h5>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        require("library.php");
                        $Lib = new Library();
                        $show = $Lib->showSimpanan();
                        while($data = $show->fetch(PDO::FETCH_OBJ))
                        {
                          echo "
                            <tr>
                              <td><strong>$data->tgl_simpanan</strong></td>
                              <td><strong>$data->id_simpanan</strong></td>
                              <td><strong>$data->nm_simpanan</strong></td>
                              <td><strong>$data->id_anggota</strong></td>
                              <td><strong>$data->nm_anggota</strong></td>
                              <td><strong>$data->besar_simpanan</strong></td>
                            </tr>
                              ";
                            }
                            ?>
...
{
  $del = $Lib->deleteSimpanan($_GET['delete']);
}
?>