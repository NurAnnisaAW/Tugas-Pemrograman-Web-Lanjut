              ...
              <div class="row">
                ...
                <i class="menu-icon tf-icons bx bx-money"></i>
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      ...
                      <form action="jenis_simpanan.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label">ID Jenis Simpanan</label>
                          <div class="col-sm-10">
                            <input type="text"  name="id_jenis" class="form-control" id="basic-default-name"  placeholder="JNSXXX" required />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label">Jenis Simpanan</label>
                          <div class="col-sm-10">
                            <input type="text" name="nm_jenis"class="form-control" id="basic-default-name" required />
                          </div>
                        </div>
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <button class="btn btn-primary" type="submit" name="addJenisSimpanan" value="Add Jenis">Submit</button>
                          </div>
                        </div>
                      </form>
                    </div>
...
<?php
  require('library.php');
  if (isset($_POST['addJenisSimpanan'])) {
    $id_jenis = $_POST['id_jenis'];
    $nm_jenis = $_POST['nm_jenis'];
    $arg = Array($_POST['id_jenis'],$_POST['nm_jenis']);

    $lib = new library();
    $add = $lib->addJenisSimpanan($arg);
    if ($add == "success") {
      echo "<script>url:location='view_all_jenis_simpanan.php';</script>";
    }
  }
?>